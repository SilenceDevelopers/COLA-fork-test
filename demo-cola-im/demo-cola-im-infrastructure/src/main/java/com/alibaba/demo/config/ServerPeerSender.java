                        ...
                        protected void initChannel(SocketChannel ch) throws Exception {
                            ...
                            pipeline.addLast(new ChannelDuplexHandler() {
                                ...
                                public void channelActive(ChannelHandlerContext ctx) throws Exception {
                                    HelloProto.ServerPeerConnected serverPeerConnected = HelloProto.ServerPeerConnected.newBuilder().setTimestamp(System.currentTimeMillis()).build();
                                    MsgSender.send(channel, serverPeerConnected);
                                }
                            });
                            //服务间的重连 fixme
